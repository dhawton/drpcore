...
Citizen.CreateThread(function()
	...
	while DRP == nil do
		TriggerEvent('drp/getSharedObject', function(obj) DRP = obj end)
		Citizen.Wait(0)
	end
	...
	DRP.UI.Menu.RegisterType(MenuType, openMenu, closeMenu)

	AddEventHandler('drpcore.ui.default:message:menu_submit', function(data)
		local menu = DRP.UI.Menu.GetOpened(MenuType, data._namespace, data._name)
	...
	AddEventHandler('drpcore.ui.default:message:menu_cancel', function(data)
	...
	AddEventHandler('drpcore.ui.default:message:menu_change', function(data)
